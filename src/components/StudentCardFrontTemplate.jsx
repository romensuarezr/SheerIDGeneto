        ...
        <div style={{
          ...
          {data.studentPhoto ? (
            ...
            <div style={{ color: '#999', fontSize: '16px', textAlign: 'center' }}>
              {t('doc.studentCard.photo')}<br/>3x4
            </div>
          )}
        </div>
